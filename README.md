...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-18 13:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/12cadb48-f9eb-4211-a2b5-ac855b9bc29a.git
$ cd 12cadb48-f9eb-4211-a2b5-ac855b9bc29a
```
